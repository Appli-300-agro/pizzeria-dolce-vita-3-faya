// Catalogue de 100 produits pour Pizzeria DOLCE VITA 3-Faya
...
const generateProducts = () => {
  ...
  for (let i = 1; i <= 100; i++) {
    ...
    products.push({
      id: `prod-${i}`,
      name: productName,
      description: `Découvrez notre ${dishBaseName}, une solution de la catégorie ${sector} proposée par Pizzeria DOLCE VITA 3-Faya. Qualité garantie.`,
